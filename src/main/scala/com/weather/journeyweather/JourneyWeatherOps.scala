...
import com.weather.dao.impl.syrt_weather.JourneyWeatherImpl
...
/**
  ...
  */
object JourneyWeatherOps {
    def main(args: Array[String]): Unit = {
        val conf = new SparkConf().setAppName(JourneyWeatherOps.getClass.getSimpleName)
        ...
        sc.textFile("C:/Users/admin/Desktop/cropsweather_1981-2010.txt")
            ...
            .foreach(t => {
                ...
                val dao = new JourneyWeatherImpl()
