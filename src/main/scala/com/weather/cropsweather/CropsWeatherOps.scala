...
import com.weather.dao.impl.syrt_weather.CropsWeatherImpl
...
/**
  ...
  */
object CropsWeatherOps {
    def main(args: Array[String]): Unit = {
        val conf = new SparkConf().setAppName(CropsWeatherOps.getClass.getSimpleName)
