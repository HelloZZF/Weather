...
/**
  ...
  */
object WinRandomForestClassificationModel {
    def main(args: Array[String]): Unit = {
        val conf = new SparkConf().setAppName(WinRandomForestClassificationModel.getClass.getName).setMaster("local[1]")
...
//        MulticlassMetrics Precision: 0.9777777777777777
//        Test Mean Squared Error = 0.02222222222222224
//        Error Diff = 0.022222222222222223
//        Error rate = 0.022222222222222223


        //保存模型
        //model.save(sc, "C:\\Users\\admin\\Desktop\\WinRandomForestClassificationModel")
