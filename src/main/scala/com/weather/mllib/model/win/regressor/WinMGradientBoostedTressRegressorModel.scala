...
/**
  ...
  */
object WinMGradientBoostedTressRegressorModel {
    def main(args: Array[String]): Unit = {
        val conf = new SparkConf().setAppName(WinMGradientBoostedTressRegressorModel.getClass.getName).setMaster("local[1]")
        val sc = new SparkContext(conf)
        sc.setLogLevel("ERROR")
        //加载LibSVM格式的数据
        val data = MLUtils.loadLibSVMFile(sc, "C:\\Users\\admin\\Desktop\\Weather\\WeatherData\\MLlib\\WinM.txt")
...
//        Test Mean Squared Error = 8.884808744691142
//        Error Diff = 2.0268847702440134
//        Error rate = 1.0


        //保存模型
        //model.save(sc, "C:\\Users\\admin\\Desktop\\WinMGradientBoostedTressRegressorModel")
