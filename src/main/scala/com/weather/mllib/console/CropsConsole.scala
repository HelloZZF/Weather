...
object CropsConsole {
    ...
    def main(args: Array[String]): Unit = {
        ...
        val model = DecisionTreeModel.load(sc,"C:\\Users\\admin\\Desktop\\Weather\\WeatherData\\MLlib\\CropsDecisionTreeClassificationModel")
    ...
    def singleCrop(br:BufferedReader, sc:SparkContext, cci:CropsConditionWeatherImpl, model:DecisionTreeModel):Unit = {
        println("请输入作物名称: ")
    ...
    def allCrops(cci:CropsConditionWeatherImpl, model:DecisionTreeModel) = {
