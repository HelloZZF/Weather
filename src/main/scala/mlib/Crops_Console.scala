...
object Crops_Console {
    ...
    def singleCrop(br:BufferedReader, sc:SparkContext,cci:CropsCondition_WeatherImpl,model:RandomForestModel):Unit = {
        println("请输入作物名称: ")
    ...
    def allCrops(cci:CropsCondition_WeatherImpl,model:RandomForestModel) = {
