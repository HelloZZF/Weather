...
public class Journey implements Serializable{
    ...
    public Journey(String city, int month, float ave_tem, float ave_max_tem, float ave_min_tem, float max_tem_more_30, float max_tem_more_35, float ave_rhu, float pre_20_20, float pre_more_25, float max_conti_pre, float max_no_pre, float ave_win, float max_win_more_10, float max_win_more_15) {
        this.city = city;
        this.month = month;
    ...
    public float getMax_no_pre() {
        return max_no_pre;
    }

    public void setMax_no_pre(float max_no_pre) {
        this.max_no_pre = max_no_pre;
    }
